...
for (count_name in count_matrices) {
  ...
  file_name <- paste0(output_dir, "/Count_PCA_M_", count_name, ".png")
  ...
  file_name_legend <- paste0(output_dir, "/Count_PCA_M_", count_name, "_legend.png")
...
cat("=== All raw count PCA plots completed for Mouse ===\n")
