...
target <- paste0(GSE, "_scRNA_matrix_all_cluster_2")
target <- paste0(GSE, "_scRNA_matrix_top2000_cluster_2")
...
melted_df <- melt(merged_df, id.vars=c("Mixture", "Treatment_Lateral"), 
                  measure.vars=c("ExN_DG", "ExN_CA", "ExN_SUB", "ExN_NA", "InN", "Astro", "Micro"))
...
file_name <- paste("/home/joonho345/3_RNA/RNA_Animal/06.Deconvolution/04.CIBER_02FractionPlot_cluster_2/",
