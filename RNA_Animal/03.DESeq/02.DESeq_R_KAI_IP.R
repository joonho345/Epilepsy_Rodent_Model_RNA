...
coldata_df_R_KAI_IP_O_CR <- coldata_df_R_I %>% filter(TYPE_1 == "R_KAI_IP_Y_CR")
filtered_samples_R_KAI_IP_O_CR <- rownames(coldata_df_R_KAI_IP_O_CR)
adjusted_df_R_KAI_IP_O_CR <- adjusted_df_R_I[, colnames(adjusted_df_R_I) %in% filtered_samples_R_KAI_IP_O_CR]
dds_data <- adjusted_df_R_KAI_IP_O_CR
dds_coldata <- coldata_df_R_KAI_IP_O_CR
Target_comparison <- 'R_KAI_IP_Y_CR'
