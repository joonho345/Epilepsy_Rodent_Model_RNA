...
coldata_df_R_KAI_SUB_Y_IM <- coldata_df_R_F %>% filter(TYPE_1 == "R_KAI_SUB_I_IM")
filtered_samples_R_KAI_SUB_Y_IM <- rownames(coldata_df_R_KAI_SUB_Y_IM)
adjusted_df_R_KAI_SUB_Y_IM <- adjusted_df_R_F[, colnames(adjusted_df_R_F) %in% filtered_samples_R_KAI_SUB_Y_IM]
dds_data <- adjusted_df_R_KAI_SUB_Y_IM
dds_coldata <- coldata_df_R_KAI_SUB_Y_IM
Target_comparison <- 'R_KAI_SUB_I_IM'


################################################
contrast_vector <- c("Treatment_Lateral","KAI_SUB","CTL_SAL_SUB")
