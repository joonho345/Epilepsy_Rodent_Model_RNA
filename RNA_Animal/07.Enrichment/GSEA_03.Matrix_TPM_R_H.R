...
adjusted_TPM_id_df_R <- read.table("/home/joonho345/1_Epilepsy_RNA/RNA_Animal/08.Enrichment/GSEA_01.Matrix_GTF/adjusted_merged_matrix_id_TPM_R.txt", 
...
adjusted_df_R_PPS_A_AC <- adjusted_TPM_id_df_R[, colnames(adjusted_TPM_id_df_R) %in% filtered_samples_R_PPS_A_AC]
adjusted_df_GSEA <- adjusted_df_R_PPS_A_AC
coldata_df_GSEA <- coldata_df_R_PPS_A_AC
...
adjusted_df_R_PPS_A_IM <- adjusted_TPM_id_df_R[, colnames(adjusted_TPM_id_df_R) %in% filtered_samples_R_PPS_A_IM]
adjusted_df_GSEA <- adjusted_df_R_PPS_A_IM
coldata_df_GSEA <- coldata_df_R_PPS_A_IM
...
adjusted_df_R_PPS_A_CR <- adjusted_TPM_id_df_R[, colnames(adjusted_TPM_id_df_R) %in% filtered_samples_R_PPS_A_CR]
adjusted_df_GSEA <- adjusted_df_R_PPS_A_CR
coldata_df_GSEA <- coldata_df_R_PPS_A_CR
...
adjusted_df_R_PPS_A_DOFS <- adjusted_TPM_id_df_R[, colnames(adjusted_TPM_id_df_R) %in% filtered_samples_R_PPS_A_DOFS]
adjusted_df_GSEA <- adjusted_df_R_PPS_A_DOFS
coldata_df_GSEA <- coldata_df_R_PPS_A_DOFS
