...
plot_unit <- 'in'
plot_dpi <- 300
file_name <- paste0("/home/joonho345/3_RNA/RNA_Animal/07.Enrichment/GSEA_06.NES_NG/NES_Plot_NG_", Treatment_type, ".png")
...
plot_unit <- 'in'
plot_dpi <- 300
file_name <- paste0("/home/joonho345/3_RNA/RNA_Animal/07.Enrichment/GSEA_06.NES_NG/NES_Plot_NG_", Treatment_type, "_without.png")
ggsave(file_name, plot = plot_target, width = plot_width, height = plot_height, dpi = plot_dpi, units = plot_unit)

file_name <- paste0("/home/joonho345/3_RNA/RNA_Animal/07.Enrichment/GSEA_06.NES_NG/NES_Plot_NG_", Treatment_type, "_without.svg")
