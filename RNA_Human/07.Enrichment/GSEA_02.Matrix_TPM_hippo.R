...
# Grouping AUD, BPD, MDD, SCZD as Psychiatric (No TSC, FCD in HIPPI subgroup)
...
gsea_output_path <- paste0("/home/joonho345/3_RNA/RNA_Human/07.Enrichment/GSEA_02.Matrix_GSEA/gsea_formatted_matrix_",group_name,"_hippo.txt")
...
output_file_path <- paste0("/home/joonho345/3_RNA/RNA_Human/07.Enrichment/GSEA_02.Matrix_GSEA/phenotype_matrix_",group_name,"_hippo.txt")
