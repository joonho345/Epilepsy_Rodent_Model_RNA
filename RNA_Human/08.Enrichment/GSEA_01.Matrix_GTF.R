...
#### Expression matrix ####
adjusted_TPM_df <- read.table("/home/joonho345/1_Epilepsy_RNA/RNA_Human/03.Normalization/adjusted_merged_matrix_1_TPM.txt", 
...
write.table(adjusted_TPM_id_matrix, file = "/home/joonho345/1_Epilepsy_RNA/RNA_Human/08.Enrichment/GSEA_01.Matrix_GTF/adjusted_merged_matrix_1_id_TPM.txt", 
