...
plot_target <- ggplot(transformed_df_long, aes(x = Group, y = Gene_Count, color = Gene_Type, group = Gene_Type)) +
  geom_hline(yintercept = c(100, 200, 300), linetype = "dashed", color = "gray", size = 0.3, alpha = 0.3) +
...
file_name <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/01.Dotplot_shared_genes_new.png"
...
file_name <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/01.Dotplot_shared_genes_new_tick.png"
ggsave(file_name, plot = plot_target, width = plot_width, height = plot_height, dpi = plot_dpi, units = plot_unit)

# without tick and line
plot_target <- ggplot(transformed_df_long, aes(x = Group, y = Gene_Count, color = Gene_Type, group = Gene_Type)) +
  geom_hline(yintercept = c(0, 100, 200, 300), linetype = "dashed", color = "gray", size = 0.3, alpha = 0.3) +
  #geom_hline(yintercept = 0, linetype = "dashed", color = "gray", size = 0.5, alpha = 0.3) +
  #geom_vline(xintercept = 20.5, linetype = "dashed", color = "black", size = 0.5, alpha = 0.5) + 
  #geom_vline(xintercept = 13.5, linetype = "dashed", color = "gray", size = 0.5, alpha = 0.5) + 
  #geom_vline(xintercept = 25.5, linetype = "dashed", color = "gray", size = 0.5, alpha = 0.5) + 
...
file_name <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/01.Dotplot_shared_genes_new_tick_line.png"
ggsave(file_name, plot = plot_target, width = plot_width, height = plot_height, dpi = plot_dpi, units = plot_unit)

file_name <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/01.Dotplot_shared_genes_new_tick_line.svg"
