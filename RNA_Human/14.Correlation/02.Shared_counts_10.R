...
output_file <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/02.Shared_Genes_M_KAI_ST_BO.txt"
...
output_file <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/02.Shared_Genes_M_PILO_Y.txt"
writeLines(genes_to_save, output_file)

genes_to_save <- union(intersections$MTLE_R_PPS_Y_DOFS_up, intersections$MTLE_R_PPS_Y_CR_up)
output_file <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/02.Shared_Genes_R_PPS_O.txt"
writeLines(genes_to_save, output_file)
...
genes_to_save <- union(intersections$MTLE_M_KAI_ST_BO_O_IM_up, intersections$MTLE_M_KAI_ST_BO_O_CR_up)
output_file <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/02.Shared_Genes_M_KAI_ST_BO_filtered.txt"
filter_and_save_genes(genes_to_save, H_gene_set_W, output_file)

genes_to_save <- union(intersections$MTLE_M_PILO_IP_Y_AC_up, intersections$MTLE_M_PILO_IP_Y_IM_up)
output_file <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/02.Shared_Genes_M_PILO_Y_filtered.txt"
filter_and_save_genes(genes_to_save, H_gene_set_W, output_file)

genes_to_save <- union(intersections$MTLE_R_PPS_Y_DOFS_up, intersections$MTLE_R_PPS_Y_CR_up)
output_file <- "/home/joonho345/3_RNA/RNA_Human/14.DEG_shared_count/02.Shared_Genes_R_PPS_O_filtered.txt"
filter_and_save_genes(genes_to_save, H_gene_set_W, output_file)
