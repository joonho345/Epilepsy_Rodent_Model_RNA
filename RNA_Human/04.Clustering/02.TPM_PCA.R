...
for (tpm_name in tpm_matrices) {
  tpm_file <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/03.Normalization/", tpm_name, ".txt")
  ...
  #### Save plot ####
  file_name <- paste0(output_dir, "/TPM_PCA_all_", tpm_name, ".png")
