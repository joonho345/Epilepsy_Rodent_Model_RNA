...
# 
OUTLIER_samples <- shared_outliers
subset <- 'all'
...
plot_unit <- 'in'
plot_dpi <- 300
file_name <- paste("/home/joonho345/3_RNA/RNA_Human/05.Sampling/08.TPM_Comparison_TPM/Boxplot_", Target_gene, "_",
                   Target_groups, "_", subset, "_", DATA, "_final.png", sep="")
