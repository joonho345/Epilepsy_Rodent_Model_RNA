# Import 
csv_file <- "/data/project/1_Epilepsy_RNA/RNA_Human/Raw_Data/Patients_sheet_FTP_2.csv"
...
write.table(Matrix_DESeq_ALL, file = "/home/joonho345/1_Epilepsy_RNA/RNA_Human/07.DESeq/DESeq_ALL.txt", 
