...
input_file_ci_low_M <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_Mouse_FILTERED_bootstrap_CI_low.txt")
bootstrap_ci_low_M <- read.table(file = input_file_ci_low_M, sep = "\t", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
input_file_ci_high_M <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_Mouse_FILTERED_bootstrap_CI_high.txt")
bootstrap_ci_high_M <- read.table(file = input_file_ci_high_M, sep = "\t", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

input_file_ci_low_R <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_Rat_FILTERED_bootstrap_CI_low.txt")
bootstrap_ci_low_R <- read.table(file = input_file_ci_low_R, sep = "\t", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
input_file_ci_high_R <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_Rat_FILTERED_bootstrap_CI_high.txt")
...
input_file_perm_M <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_Mouse_FILTERED_perm_pvalue.txt")
perm_pvalue_M <- read.table(file = input_file_perm_M, sep = "\t", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
input_file_perm_R <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_Rat_FILTERED_perm_pvalue.txt")
...
plot_target <- ggplot(transformed_df, aes(x = Group, y = Correlation)) +
  geom_hline(yintercept = c(0.1, 0.2, 0.3, 0.4), linetype = "dashed", color = "gray", size = 0.3, alpha = 0.3) +
...
file_name <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/02.Dotplot_correlation/02.Dotplot_correlation_Epileptogenesis_", Target_group_name, ".png")
