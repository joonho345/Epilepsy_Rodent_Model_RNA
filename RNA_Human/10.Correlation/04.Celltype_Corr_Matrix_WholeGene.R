...
output_file <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/04.CellType_Matrix/01.Correlation_WholeGene_Allcelltype", 
                      Human_groups_name, ".txt")
write.table(merged_correlation_matrix, file = output_file, sep = "\t", quote = FALSE, col.names = TRUE)

output_file <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/04.CellType_Matrix/02.Pvalue_WholeGene_Allcelltype", 
                      Human_groups_name, ".txt")
