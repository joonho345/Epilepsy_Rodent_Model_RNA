...
transformed_df_long <- transformed_df %>%
  ...
  mutate(Group = factor(Group, levels = group_order))
print(transformed_df_long, n = Inf)
...
file_name <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/03.Dotplot_shared_genes/01.Dotplot_shared_genes_WholeGene_", Target_group_name, ".png")
