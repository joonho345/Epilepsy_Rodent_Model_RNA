...
ortholog_one2one_filtered <- ortholog_one2one[ortholog_one2one$Gene.name %in% H_gene_set_W, ]
animal_genes <- ortholog_one2one_filtered[[Species_Gene_name]]
...
heat_plot <- Heatmap(correlation_matrix,
                     ...
                     column_title = paste0("Correlation (Human vs. ", Species, " Models) - Epileptogenesis GO Genes"), # Add title
...
# Save the heatmap
file_name <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_", 
...
output_file <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_", Species, Human_groups_name, ".txt")
...
output_file_pvalue <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_", Species, Human_groups_name, "_pvalue.txt")
write.table(pvalue_matrix, file = output_file_pvalue, sep = "\t", quote = FALSE, col.names = TRUE)

output_file_perm_pvalue <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_", Species, Human_groups_name, "_perm_pvalue.txt")
write.table(perm_pvalue_matrix, file = output_file_perm_pvalue, sep = "\t", quote = FALSE, col.names = TRUE)

output_file_bootstrap_ci_low <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_", Species, Human_groups_name, "_bootstrap_CI_low.txt")
write.table(bootstrap_ci_low_matrix, file = output_file_bootstrap_ci_low, sep = "\t", quote = FALSE, col.names = TRUE)

output_file_bootstrap_ci_high <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/01.Correlation/02.Correlation_Epileptogenesis_", Species, Human_groups_name, "_bootstrap_CI_high.txt")
