...
# MOUSE
input_file <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/04.CellType_Matrix/01.Correlation_WholeGene_Allcelltype_1.txt")
...
################# p value #################
# MOUSE
input_file <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/04.CellType_Matrix/02.Pvalue_WholeGene_Allcelltype_1.txt")
correlation_matrix_CELLTYPE <- read.table(file = input_file, sep = "\t", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
df_list <- list(correlation_matrix_CELLTYPE) 
combined_df_M <- do.call(rbind, df_list)
...
plot_unit <- 'in'
plot_dpi <- 300
file_name <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/04.CellType_Matrix/03.Dotplot_Celltype_WholeGene.png")
