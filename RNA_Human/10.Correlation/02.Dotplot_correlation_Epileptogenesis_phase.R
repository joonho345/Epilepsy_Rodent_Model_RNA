...
#### Get H_gene_set_W from 00.Geneset.R ####
if (!exists("H_gene_set_W")) {
  source("/home/joonho345/1_Epilepsy_RNA/00.Geneset.R")
  if (!exists("H_gene_set_W")) {
    stop("ERROR: H_gene_set_W not found. Please run 00.Geneset.R first or ensure H_gene_set_W is defined.")
  }
}
...
for (phase in names(phase_list)) {
  ...
  file_name <- paste0("/home/joonho345/1_Epilepsy_RNA/RNA_Human/10.Correlation/02.Dotplot_correlation/02.Dotplot_correlation_Epileptogenesis_", Target_group_name, "_Phase_", phase, ".png")
